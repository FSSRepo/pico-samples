...
//          Adaptada para Raspberry Pi Pico SDK (reemplaza Arduino.h / Wire.h)
...
#define SHT31_LIB_VERSION             "0.5.3-pico"
...
{
public:
  SHT31(uint8_t address = SHT_DEFAULT_ADDRESS, i2c_inst_t *i2c = nullptr);
